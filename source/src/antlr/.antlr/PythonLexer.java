// Generated from c:/Users/DELL/python_flask_compiler/source/src/antlr/PythonLexer.g4 by ANTLR 4.13.1
...
public class PythonLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"MULTI_LINE_COMMENT", "DIGIT", "NUM", "INT", "FLOAT", "ESC", "EXPLICIT_LINE_JOINING", 
			"F_STRING", "STRING", "BOOLEAN", "FALSE", "TRUE", "KEYWORD_CASE", "CHARACTER", 
			"NAME"
		};
	}
	...
	public void action(RuleContext _localctx, int ruleIndex, int actionIndex) {
		...
		case 0:
			...
			break;
		case 1:
			LSQB_action((RuleContext)_localctx, actionIndex);
			break;
		case 2:
		...
		case 3:
			...
			break;
		case 4:
			RSQB_action((RuleContext)_localctx, actionIndex);
			break;
		case 5:
	...
	private void LSQB_action(RuleContext _localctx, int actionIndex) {
		switch (actionIndex) {
		case 1:
			 opened++; 
			break;
	...
	private void RPAR_action(RuleContext _localctx, int actionIndex) {
		switch (actionIndex) {
		case 3:
			 opened--; if (opened < 0) opened = 0; 
			break;
		}
	}
	private void RSQB_action(RuleContext _localctx, int actionIndex) {
		switch (actionIndex) {
		case 4:
			 opened--; if (opened < 0) opened = 0; 
			break;
